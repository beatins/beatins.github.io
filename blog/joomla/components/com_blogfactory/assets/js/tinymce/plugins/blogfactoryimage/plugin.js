...
tinymce.PluginManager.add('blogfactoryimage', function(editor) {
	function showDialog() {
    ...
    function buildAlignList() {
      ...
      {label: 'Alignment', name: 'alignment', type: 'listbox', values: buildAlignList(), onselect: updateStyle }
		];
      ...
      switch (data.alignment) {
        ...
        data.alignment = imgElm.style.cssFloat;
			}
	...
	editor.addButton('blogfactoryimage', {
		icon: 'image',
