...
<tr class="comment-wrapper <?php echo $this->item->approved ? '' : 'comment-pending'; ?> <?php echo $this->item->reported ? 'comment-reported' : ''; ?>">
  ...
  <td class="hidden-phone">
    <img class="blogfactory-avatar" src="<?php echo JHtml::_('BlogFactoryComments.getAvatarSource', $this->item); ?>" />
  ...
  <td colspan="2">
    <div class="smalls">
      <div style="margin-bottom: 5px;">
        ...
        <span class="small muted"><?php echo JHtml::_('date', $this->item->created_at, 'DATE_FORMAT_LC2'); ?></span>

        <?php if (!$this->post): ?>
          <a href="<?php echo JHtml::_('BlogFactoryDashboard.manageCommentsFilterPost', $this->item->post_id); ?>" class="hasTooltip" title="<?php echo BlogFactoryText::plural('managecomments_post_comments_tooltip', $this->item->comments_total); ?>"><i class="factory-icon-balloon"></i><?php echo $this->item->comments_total; ?></a>
        <?php endif; ?>
      </div>
