...
<div class="blogfactory-view view-managecomment">
  ...
  <form action="<?php echo BlogFactoryRoute::task('managecomment.save&id=' . $this->item->id); ?>" method="POST" novalidate>
    <div class="row-fluid">
      <div class="span8">
      ...
      <div class="span4">
        <div class="blogfactory-edit-box">
          ...
          <div class="blogfactory-edit-box-content">
            ...
            <div class="padded status-box">
              <a href="<?php echo BlogFactoryRoute::task('managecomment.delete&id=' . $this->item->id); ?>" class="muted btn btn-link btn-small button-delete">
