...
<div class="blogfactory-view view-managebookmarks">
  <h1>
    <?php echo BlogFactoryText::_('managebookmarks_page_heading'); ?>
  </h1>
  ...
  <?php else: ?>
    <p><?php echo BlogFactoryText::_('managebookmarks_no_items_found'); ?></p>
  <?php endif; ?>
</div>
