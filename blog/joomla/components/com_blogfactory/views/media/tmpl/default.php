...
<div class="pane-upload" style="display: none;">
  ...
  <div style="float: right;">
    <a href="#" class="btn btn-small button-clear-list"><?php echo BlogFactoryText::_('media_upload_clear_list_button'); ?></a>
    <a href="#" class="btn btn-small button-close"><?php echo BlogFactoryText::_('media_upload_close'); ?></a>
  </div>

  <div class="small muted" style="margin-top: 5px;"><?php echo BlogFactoryText::sprintf('media_upload_warning', $this->maxUploadSize); ?></div>
...
<div class="pane-file-details">
  <div class="details" style="display: none;">
    ...
    <div id="details_alt_text_wrapper">
      <label for="details_alt_text"><?php echo BlogFactoryText::_('media_filed_details_alt_text_label'); ?></label>
    ...
    <div id="details_size_wrapper">
      ...
      <select id="details_size" name="details[size]">
        <option value="thumbnail"><?php echo BlogFactoryText::_('media_filed_details_size_option_thumbnail'); ?></option>
        <option value="medium"><?php echo BlogFactoryText::_('media_filed_details_size_option_medium'); ?></option>
        <option value="large"><?php echo BlogFactoryText::_('media_filed_details_size_option_large'); ?></option>
        <option value="original"><?php echo BlogFactoryText::_('media_filed_details_size_option_original'); ?></option>
      </select>
      ...
      <select id="details_align" name="details[align]">
        ...
        <option value="right"><?php echo BlogFactoryText::_('media_filed_details_align_option_right'); ?></option>
      </select>
    </div>
    ...
    <select id="details_link_type" name="details[link_type]">
      ...
      <option value="media" selected="selected"><?php echo BlogFactoryText::_('media_filed_details_link_type_option_media'); ?></option>
      <option value="custom"><?php echo BlogFactoryText::_('media_filed_details_link_type_option_custom'); ?></option>
    </select>

    <input type="text" id="details_link" name="details[link]" readonly="readonly" />

    <div style="margin-top: 10px;">
      <a href="#" class="btn btn-primary button-insert-file"><?php echo BlogFactoryText::_('media_filed_details_button_insert'); ?></a>
    </div>
  </div>
</div>
...
<div class="pane-new-folder" style="display: none;">
  <input id="folder_title" type="text" placeholder="<?php echo BlogFactoryText::_('media_create_folder_placeholder'); ?>" />
  <a href="#" class="btn btn-small btn-success button-submit"><i class="factory-icon-loader" style="display: none;"></i><?php echo BlogFactoryText::_('media_create_folder_button'); ?></a>
  <a href="#" class="btn btn-small btn-danger button-cancel"><?php echo BlogFactoryText::_('media_create_folder_cancel'); ?></a>
</div>
