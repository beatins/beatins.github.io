...
<form>
  <input id="quickpost_title" name="quickpost[title]" type="text" placeholder="<?php echo BlogFactoryText::_('dashboard_portlet_quickpost_title_placeholder'); ?>" />
  <textarea id="quickpost_content" name="quickpost[content]" placeholder="<?php echo BlogFactoryText::_('dashboard_portlet_quickpost_content_placeholder'); ?>" rows="5"></textarea>
</form>
