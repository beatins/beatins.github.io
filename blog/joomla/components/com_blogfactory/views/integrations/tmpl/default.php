  ...
  <div class="tabbable tabs-left">
    <ul class="nav nav-tabs">
      <?php foreach ($this->extensions as $element => $title): ?>
        <li class="<?php echo $this->extension == $element ? 'active' : ''; ?>"><a href="<?php echo BlogFactoryRoute::view('integrations&tmpl=component&extension=' . $element); ?>"><?php echo $title; ?></a></li>
      <?php endforeach; ?>
    </ul>
