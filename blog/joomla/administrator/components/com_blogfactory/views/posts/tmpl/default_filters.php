...
<div id="filter-bar" class="btn-toolbar">
  <div class="filter-search btn-group pull-left">
    <label for="filter_search" class="element-invisible"><?php echo BlogFactoryText::_('filter_search_desc'); ?></label>
    <input type="text" name="filter_search" placeholder="<?php echo BlogFactoryText::_('filter_search_desc'); ?>" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo BlogFactoryText::_('filter_search_desc'); ?>" />
  </div>
