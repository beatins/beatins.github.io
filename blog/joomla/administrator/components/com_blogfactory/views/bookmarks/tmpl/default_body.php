...
foreach ($this->items as $this->i => $this->item): ?>
  <tr>
    <td class="order nowrap center hidden-phone">
      ...
      <input type="text" style="display:none" name="order[]" size="5" value="<?php echo $this->item->ordering; ?>" class="width-20 text-area-order " />
    </td>
    ...
    <td class="nowrap has-context">
      <a href="<?php echo BlogFactoryRoute::task('bookmark.edit&id=' . $this->item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
